    ...
    <div className="h-full ">
     <div className="w-full  p-4 pt-0  ">
      <div className="h-16 flex justify-between  items-center  ">
        ...
        <div className=" h-9 w-28 rounded-full p-1 flex flex-row items-center justify-between bg-[#131313]">
            <div 
             style={{backgroundImage: `url(${userInfo?.userImage.url})`}}
            className=" h-8 w-8 rounded-full bg-cover">

            </div>
            <span className=" font-spotifythin text-white">{userInfo?.userName}</span>
      ...
      <div className=" h-14 p-4 pb-0  font-spotifybold text-3xl text-white">
        Good evening
      </div>

      <div className="h-60 p-4 pt-4 grid gap-x-8 gap-y-4 grid-cols-3 ">
        {
