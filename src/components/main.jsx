  ...
  useEffect(() => {
    const getAlbums = async () => {
      ...
      const [res1, res2, res3] = await axios.all([
        axios.get(
          "https://api.spotify.com/v1/browse/featured-playlists?country=US&language=en",
          config
        ),
        axios.get(
        ...
        axios.get(
          `https://api.spotify.com/v1/artists?ids=2IDLDx25HU1nQMKde4n61a,7tYKF4w9nC0nq9CsPZTHyP,1AhjOkOLkbHUfcHDSErXQs,1Xyo4u8uXC1ZmMpatF05PJ,0Y5tJX1MQlPlqiwlOH1tJY,7pbDxGE6nQSZVfiFdq9lOL,6UbmqUEgjLA6jAcXwbM1Z9`,
          config1
        ),
      ]);
