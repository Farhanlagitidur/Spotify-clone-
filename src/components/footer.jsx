...
const communities = ['Communities','For Artists','Developers','Advertising','Investors','Vendors']
const usefullink = ['Useful links','Support','Free Mobile App']

const List = ({item,id}) => {
    return (
        <ul className=' font-spotifylight text-[14px] text-[#B3B3B3] '>
             <li className={`m-3 cursor-pointer ${id === 0 && 'text-white cursor-default'}`}>{item}</li>
       </ul>
    )
}
  ...
  return (
    <>
    <div className="h-60 mt-20 justify-between flex">
        ...
        <div className=' w-3/5 h-full'>
            <div className=' flex flex-row items-center justify-end '>
                <div className='bg-[#292929] m-2 rounded-full p-2 h-9 cursor-pointer items-center'>
                ...
                <div className='bg-[#292929] m-2 rounded-full p-2 h-9 cursor-pointer'>
                    <svg className='h-5 w-5' viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className=' h-32 w-full border-t-[1px] border-[#414040] text-[#B3B3B3] flex justify-between items-center font-spotifylight text-[13px] '>
        <div className='flex flex-row  w-1/2 list-none'>
            <li className='m-2'>Legal</li>
            <li className='m-2'>Privacy Center</li>
            <li className='m-2'>Privacy Policy</li>
            <li className='m-2'>Cookies</li>
            <li className='m-2'>About Ads</li>
        </div>
        <div className='  w-1/2'>
